...
# Per Part #5, let's use 3-fold CV repeated 10 times 
...
# Essentially, the last part is to see if we can engineer new features and improve the model even more. 
# There is more potential for building more accurate models that do not overfit. The final model uses 4 features 
# leaving lots of potential. The use of tsne was simply to illustrate techniques for visualizing high dimensional data 
# in lower dimensions to help build understanding of what is going on.
