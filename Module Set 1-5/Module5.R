...
legend('topright', colnames(rf.4$err.rate), col=1:3, fill=1:3)
...
legend('topright', colnames(rf.5$err.rate), col=1:3, fill=1:3)
...
legend('topright', colnames(rf.6$err.rate), col=1:3, fill=1:3)
...
legend('topright', colnames(rf.7$err.rate), col=1:3, fill=1:3)
...
#          overall accuracy rate of 83.2 %. (79.8226)
